...
3. Crane argues that mental representation is fundamental in part because
...
4. Intentionality is the feature of a mental state such that

    A. it is something a subject does
    B. it is directed at or about something
    C. it is a picture
    D. it is something we have in common with machines
