...
#+BEGIN_QUOTE
  ...
  C. That we cannot conceive of how physicalism could be false\\
...
#+BEGIN_NOTES
- What is it that is the locus of incompatibility? 
#+END_NOTES
...
-  Is determinism compatible with free will?
  #+ATTR_REVEAL: :frag (appear)
   -  Yes: ‘Compatibilism'
      #+ATTR_REVEAL: :frag (appear)
      -  Compatibilism explain /why/ freedom & determinism are compatible, not
...
- Jones_4: acts for his own reasons, but if there was any sign of his
  acting differently, he would have been forced to carry out the act anyway
...
#+ATTR_REVEAL: :frag (appear)
-  The Principle of Alternate Possibilities (PAP): :: a person is morally
     responsible for what s/he has done only if s/he could have done otherwise
     (or chosen otherwise)
-  Leeway Incompatibilism: :: The truth of determinism is *incompatible* with an
     agent's having the capacity to do otherwise than as she did, and thus
     with an agent's acting freely

*** Question 3

According to Frankfurt, determinism and free will (and responsibility)
...
-  Frankfurt cases suggest that responsibility depends on the source of the
  agent's decision for acting (i.e. their reasons for acting) rather than the
  ability to do otherwise
#+ATTR_REVEAL: :frag (appear)
-  If Determinism is true can we really be considered the sources of our actions?
...
#+REVEAL: split
#+BEGIN_QUOTE
  Jane is considering what to eat in the student union. Unbeknownst to her,
  Subway is filling the air with a chemical that subliminally generates in
  people an intention to eat a sandwich. Jane breathes the chemical, forms the
...
1. Suppose that you have intentionally brought it about that you are the way
   you now are, and in a manner that makes you truly responsible for being the
   way you now are
...
5. \therefore (1) is false: It is impossible for you to have intentionally brought it
   about that you are as you are now
...
4. \therefore There is a persistent and inescapable mismatch between the conditions of
   life (the objective) and the conditions under which it is lived (the
   subjective)
...
- What is the relation between (a) and (b) ? 
  #+ATTR_REVEAL: :frag (appear)
  - Cannot be merely accidental
    #+ATTR_REVEAL: :frag (appear)
    - pot-smoker 
  - Cannot be solely for something positive
    #+ATTR_REVEAL: :frag (appear)
    - conscripted soldier
...
** Time & Place
- TEACH 105
- 10:00 to 12:00 noon, Wednesday, December 13^th
...
5. An invalid argument is an argument where
A. The premises are always false\\
B. The conclusion is always false\\
C. The conclusion is always true\\
D. The truth of the premises does not guarantee the truth of the
conclusion\\
...
2. T/F: Incompatibilism says that if determinism is true then there is no free will of the kind necessary for moral responsibility
3. T/F: The truth of Determinism settles the question of whether or not we have free will
...
5. T/F: If Determinism is true then we never make any choices
...
5. According to the Model Penal Code, one is not culpable unless one's
   action or omission to act was voluntary
...
B, B, C, C, A
** Noncognitivism
1. Meta-ethics asks questions about what we ought to do or what we should value.

    > A. true
    > B. false

2. Non-cognitivism about moral thought & talk means that

    > A. there are no objective moral values
    > B. there are objective moral values
    > C. moral claims aren't the kind of claim that can be true or false
    > D. moral claims are all false

3. Non-cognitivism about moral thought & talk is incompatible with moral
   skepticism

    > A. true
    > B. false

4. A moral judgment is 'categorical' because

    > A. it is true
    > B. it is false
    > C. it's authority depends on what people want or think
    > D. it's authority is independent of what people otherwise want or think

5. Mackie thinks that supposedly widespread and intractable disagreements
   about value are best explained by

    > A. the existence of objective moral values
    > B. the fact that moral claims are neither true nor false
    > C. the non-existence of objective moral values
    > D. the irrationality of human beings
...
5. Nagel thinks that the death argument fails as a reason for thinking life is meaningless because

A. death isn't relevant to the meaning of life
B. not everyone dies
C. some deaths are more meaningful than others
D. our finite lifespan doesn't affect the fact that we can give reasons for actions within our lives
...
A. Robots can lift more than humans \\
B. Robots live are tougher than humans \\
C. A computer program of sufficient complexity can model the function of human thought \\
D. A computer program of sufficient complexity can think
...
C. Caused by complex mental states (thoughts)  \\
...
D. responsibility for a choice requires that one be the appropriate source of the choice
...
A. we cannot make any choices\\
B. our choices are not causally effective\\
C. our current states are necessitated by our past states in conjunction with physical laws\\
D. we are free
...
B. determinism is true\\
C. determinism is false\\
D. in certain crucial respects you cannot have intentionally brought it about that you are as you are now

*** Strawson's Argument
1. You do what you do because of the way you are.
2. To be morally responsible for what you do you must be truly morally responsible for the way you are -- at least in certain crucial mental respects.
3. To be truly responsible for the way you are, you must have intentionally brought it about that you are the way you are
4. It is impossible to have intentionally brought about how one is
5. \therefore You cannot be truly morally responsible for what you do, because you cannot be truly responsible for the way you are
...
D. We would need to appeal to an infinite number of different characters or natures to explain any intentional action
...
1. Suppose that you have somehow intentionally brought it about that you
   ...
   way you now are
2. Your intentional act, for which you are responsible, is due to some nature N
3. If you are truly responsible for this act you must be truly responsible for having the nature N in virtue of which you intentionally brought it about that you are the way you now are
4. \therefore You must have intentionally brought about N, which requires that you have some further nature N1, in virtue of which you brought about your nature N... (absurd infinite regress ensues)
5. \therefore (1) is false: It is impossible for you to have intentionally brought it about that you are as you are now
...
*** Question 2
According to 'Internalism' 

A. one is always motivated
B. knowledge of the good motivates one to do what is good
C. knowledge of the good is subjective
D. knowledge of the good is objective

*** Mackie's "Internalist" Assumption

-  Internalism: :: objective values must be intrinsically motivating ---
                   knowledge of a moral requirement entails being motivated to
...
A. knowledge of the good always motivates one to do the good
B. one is never motivated to do what is good
C. one is always motivated one to do good
D. one's motivation to do good is independent of one's knowledge of the good


*** Externalism

-  Externalism: :: The motivational force of value (i.e. something good or
                   bad) is a contingent psychological fact, depending on the
                   psychological structure of an agent

*** Question 4

The amoralist is a problem for
...
B. are unsatisfying  \\
C. do not account for why we think it is important to do certain kinds of thing and not just experience them \\
D. value pain and avoid pleasure \\
#+END_QUOTE
