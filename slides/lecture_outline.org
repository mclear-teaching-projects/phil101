...
#+BEGIN_QUOTE
    A. we cannot make any choices    B. our choices are not causally
  effective    C. the state of subject, plus the laws of nature,
  necessitate the future states of the subject    D. we are free
#+END_QUOTE
...
#+BEGIN_QUOTE
     A. you cannot do otherwise than you do     B. indeterminism is
  true     C. determinism is false     D. you cannot have intentionally
  brought it about that you are as you are now in certain crucial
  respects
#+END_QUOTE
...
#+BEGIN_QUOTE
   A. determinism is false  B. determinism is true  C. if determinism is
  true then one could not do otherwise than one does  D. if determinism
  is true then one cannot be the proper source of one's actions
#+END_QUOTE
