...
1. True or False: According to the Knowledge Argument there is more to knowing what it is like to see a color than just knowing the physical information/facts.

2. True or False: The physicalist asserts that Mary learns phenomenal
   information when she leaves the B&W room

3. True or False: Jackson does not think that qualia are epiphenomenal
