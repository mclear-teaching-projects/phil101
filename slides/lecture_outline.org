...
-  Freedom of Will: :: (1) a capacity of an agent to (2) choose
   ...
   alternatives such that (4) she is responsible for that choice or
   action
...
#+BEGIN_QUOTE
  ...
  threatened her with detention (or worse) if she didn't
#+END_QUOTE
...
-  Is she to be (morally) praised for sharing the chocolate?
   #+ATTR_REVEAL: :frag (appear)
   -  deserving praise vs. praising to shape her future behavior
...
-  Alternate Possibilities: moral responsibility is incompatible with
   the fact that the agent could not have done otherwise

** Alternate Possibilities

#+BEGIN_QUOTE
  If you believed that [you couldn't have acted any other way] about
  yourself and other people, it would probably change the way you felt
  about things. For instance, could you blame yourself for giving in to
  temptation and having the cake? Would it make sense to say, “I really
  should have had a peach instead,” if you /couldn't/ have chosen a
  peach instead? It certainly wouldn't make sense to say it if there
  /was no/ fruit. So how can it make sense if there /was/ fruit, but you
  couldn't have chosen it because it was determined in advance that you
  would choose cake? (Nagel, 53)
#+END_QUOTE
...
** The Efficacy of Conscious Willing
   :PROPERTIES:
   :CUSTOM_ID: the-efficacy-of-conscious-willing-4
   :END:
...
** The Efficacy of Conscious Willing
   :PROPERTIES:
   :CUSTOM_ID: the-efficacy-of-conscious-willing-5
   :END:
...
#+BEGIN_QUOTE
  ...
  D. responsibility for a choice requires that one be the appropriate
